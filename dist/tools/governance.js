import { z } from "zod";
export function registerGovernanceTools(server, lido) {
    server.tool("lido_proposals", "List Lido DAO governance proposals from the Aragon voting contract. Filter by status (active/passed/rejected).", {
        status: z
    ...
    server.tool("lido_vote", "Cast a vote on a Lido DAO governance proposal. Requires LDO tokens. Use dry_run to check eligibility first.", {
